...
import com.sist.dao.*;
/*
 *     1. JButton , JMenu, JTextField => ActionListner
 *     2. JLabel, JTable => MouseListener
...
public class BoardListPanel extends JPanel implements ActionListener,MouseListener{
    ...
    public BoardListPanel(ControllPanel ctrP)
    {
		...
		String[] col= {"번호","제목","이름","작성일","조회수"}; //<tr><tr></tr>....</tr>
    ...
    public void print()
    {
    	...
    	for(BoardVO vo:list)
    	{
    		String[] data={
    			...
    			vo.getSubject(),
    			vo.getName(),
    			vo.getRegdate().toString(), // String으로 변환해서 들어가야 인식
